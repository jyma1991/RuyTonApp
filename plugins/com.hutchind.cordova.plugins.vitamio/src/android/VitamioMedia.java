...
public class VitamioMedia extends Activity implements ImageLoadTaskListener,
    ...
    RelativeLayout videoBgimageRel;
    public static final int HIDDEN_TOP_BAR = 1;
    public static final int SHOW_TOP_BAR = 2;
    @Override
    protected void onResume() {
        ...
        if(videoBgimageRel!=null){
            videoBgimageRel.setVisibility(View.VISIBLE);
        }
    ...
    public void onCreate(Bundle icicle) {
        ...
        preferences =  getSharedPreferences("vitamio", MODE_PRIVATE);
        ...
        if (extras == null) {
            ...
            top_rel = (RelativeLayout) topRelativeLayout.findViewById(R.id.top_rel);
            videoBgImage = (ImageView) topRelativeLayout.findViewById(R.id.video_bg_image);
            videoLinear  = (LinearLayout) topRelativeLayout.findViewById(R.id.video_linear);
            videoBgimageRel = (RelativeLayout) topRelativeLayout.findViewById(R.id.video_bg_image_rel);
            //videoBgImage.setBackgroundResource(R.drawable.ic_launcher);
            RelativeLayout exitVideo = (RelativeLayout) topRelativeLayout.findViewById(R.id.exitVideo);
    ...
    public void onPrepared(MediaPlayer mediaplayer) {
        ...
        if (mMediaPlayer != null && mIsMediaReadyToBePlayed) {
           ...
           // videoLinear.setBackgroundColor(0);
            videoBgimageRel.setVisibility(View.GONE);
    ...
    class HiddenTitleBar extends  TimerTask{
        @Override
        public void run() {
           handler.sendEmptyMessage(HIDDEN_TOP_BAR);
        }
    }
    ...
    private void setupMedia() {
        doCleanUp();
        try {
            String mediaUrl = extras.getString("mediaUrl");
            if(TextUtils.isEmpty(mediaUrl)){
                mediaUrl = preferences.getString("mediaUrl","");
            }else{
                preferences.edit().putString("mediaUrl",mediaUrl).commit();
            }
    ...
    private void fixMediaSize() {
        ...
        ViewGroup.LayoutParams videoParams = mMediaView.getLayoutParams();
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if(getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE){
            ...
            handler.sendEmptyMessage(SHOW_TOP_BAR);
        }
    }
